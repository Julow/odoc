...
Now, compile the pages with the --impl option:
  ...
  $ odoc compile -I . --impl a.ml --source-parent page-root --source-relpath fake_src/a.ml a.cmt
  $ odoc link -I . a.odoc
  $ odoc html-generate --indent -o html a.odocl
  ...
  $ grep source_link html/A/index.html -B 2
    <header class="odoc-preamble">
     <h1>Module <code><span>A</span></code>
      <a href="../root/fake_src/a.ml.html" class="source_link">Source</a>
  --
      <div class="spec type anchored" id="type-t">
       <a href="#type-t" class="anchor"></a>
       <a href="../root/fake_src/a.ml.html#def-0" class="source_link">Source
  --
      <div class="spec value anchored" id="val-x">
       <a href="#val-x" class="anchor"></a>
       <a href="../root/fake_src/a.ml.html#def-1" class="source_link">Source
  --
      <div class="spec value anchored" id="val-y">
       <a href="#val-y" class="anchor"></a>
       <a href="../root/fake_src/a.ml.html#def-2" class="source_link">Source
  --
      <div class="spec value anchored" id="val-z">
       <a href="#val-z" class="anchor"></a>
       <a href="../root/fake_src/a.ml.html#def-3" class="source_link">Source
  --
      <div class="spec module anchored" id="module-A">
       <a href="#module-A" class="anchor"></a>
       <a href="../root/fake_src/a.ml.html#def-5" class="source_link">Source
  --
