Similar to Astring library.
  ...
  $ odoc compile --hidden --impl a_x.ml --source-parent page-root --source-relpath a/x.ml -I . a_x.cmt
  $ odoc compile --impl a.ml --source-parent page-root --source-relpath a.ml -I . a.cmti
