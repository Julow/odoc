...
and rename_bound_idents s sg =
  ...
  | Module (id, r, m) :: rest ->
      ...
      rename_bound_idents
        ( add_module id (local_module_path s id') (`Local id) s
  ...
  | ModuleType (id, mt) :: rest ->
      ...
      rename_bound_idents
        ( add_module_type id (local_module_type_path s id') (`Local id) s
        |> add_id_map (id :> Ident.any) (id' :> Ident.any) )
        (ModuleType (id', mt) :: sg)
        rest
  | Type (id, r, t) :: rest ->
      ...
      rename_bound_idents
        ( add_type id (local_type_path s (id' :> Ident.path_type)) (`Local (id' :> Ident.path_type)) s
        |> add_id_map (id :> Ident.any) (id' :> Ident.any) )
        (Type (id', r, t) :: sg)
        rest
