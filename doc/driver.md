...
This parent/child specification allows more flexible output support, for example, per library documentation. See [docs.ocaml.org](https://docs.ocaml.org).
...
**Note:** The `--pkg <package>` option is still being supported for backward compatibility in `odoc >= v2.0.0`,
